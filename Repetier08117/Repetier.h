...
#define REPETIER_VERSION "1.0.0devRAY"
...
#if SUPPORT_M6 && M6_ACK_PIN < 0
#error You need to define M6_ACK_PIN to support Gcode M6!
#endif
//###################
...
#define MM_PER_ARC_SEGMENT 0.1 //1
#define MM_PER_ARC_SEGMENT_BIG 0.5 //3
#else
...
//###### RAyWB for Control via Analog Joystick
