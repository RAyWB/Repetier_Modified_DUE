...
*/
#define STARTUP_GCODE "M117 Giovanni_dev_Jan 17"
...
#define XAXIS_STEPS_PER_MM 533.33334
...
#define EXT0_STEPS_PER_MM 744//612 
...
#define EXT0_EXTRUDER_COOLER_PIN  EXT0_FAN_PIN 
...
#define EXT1_ENABLE2_PIN E1_ENABLE_PIN
// The following speed settings are for skeinforge 40+ where e is the
// length of filament pulled inside the heater. For repsnap or older
// skeinforge use higher values.
//  Overridden if EEPROM activated.
...
/** The extruder cooler is a fan to cool the extruder when it is heating. If you turn the extruder on, the fan goes on. */
#define EXT1_EXTRUDER_COOLER_PIN  EXT1_FAN_PIN 
/** PWM speed for the cooler fan. 0=off 255=full speed */
...
#define EXT2_STEP2_PIN E2_STEP_PIN
#define EXT2_DIR2_PIN E2_DIR_PIN
#define EXT2_INVERSE2 false
#define EXT2_ENABLE2_PIN E2_ENABLE_PIN
// The following speed settings are for skeinforge 40+ where e is the
// length of filament pulled inside the heater. For repsnap or older
// skeinforge use higher values.
//  Overridden if EEPROM activated.
...
/** D-gain.  Overridden if EEPROM activated.*/
#define EXT2_PID_D 200
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
#define EXT2_PID_MAX 180
/** \brief Faktor for the advance algorithm. 0 disables the algorithm.  Overridden if EEPROM activated.
K is the factor for the quadratic term, which is normally disabled in newer versions. If you want to use
the quadratic factor make sure ENABLE_QUADRATIC_ADVANCE is defined.
L is the linear factor and seems to be working better then the quadratic dependency.
...
/** The extruder cooler is a fan to cool the extruder when it is heating. If you turn the extruder on, the fan goes on. */
#define EXT2_EXTRUDER_COOLER_PIN  EXT2_FAN_PIN 
/** PWM speed for the cooler fan. 0=off 255=full speed */
...
#define SKIP_M190_IF_WITHIN 10//5
...
#define LASER_PIN ORIG_LASER_PIN    // set to pin enabling laser
#define LASER_ON_HIGH 1 // Set 0 if low signal enables laser

#define LASER_WARMUP_TIME 150// wait x milliseconds to start material burning before move

/*############################ SAFETY DOOR for LASER Mode*/

#define FEATURE_SAFETY_DOOR true
#define SAFETY_PIN ORIG_SAFETY_PIN
#define SAFETY_PIN_PULLUP 1

#if (FEATURE_SAFETY_DOOR && SAFETY_PIN > -1)
#define LASER_SAFE (!READ(SAFETY_PIN))
#else 
#define LASER_SAFE true
#endif
...
#define CNC_WAIT_ON_ENABLE 10000 // wait x milliseconds after enabling
#define CNC_WAIT_ON_DISABLE 10000 // delay in milliseconds after disabling spindle. May be required for direction changes.
#define CNC_ENABLE_PIN ORIG_CNC_ENABLE_PIN // Pin to enable mill
#define CNC_ENABLE_WITH 1 // Set 0 if low enables spindle
#define CNC_DIRECTION_PIN ORIG_CNC_DIR_PIN // Set to pin if direction control is possible
#define CNC_DIRECTION_CW 1 // Set signal required for clockwise rotation

//################### Acknowledge Button################

#define SUPPORT_M6 true
#define M6_ACK_PIN ORIG_M6_ACK_PIN
#define M6_ACK_PIN_PULLUP 1
#if (SUPPORT_M6 && M6_ACK_PIN > -1)
...
#define X_MAX_LENGTH 505
#define Y_MAX_LENGTH 260
#define Z_MAX_LENGTH 204.80
...
#define Z_BACKLASH 0
#define X_BACKLASH 0.005
#define Y_BACKLASH 0.005
...
Overridden if EEPROM activated.
*/
//#define ALTERNATIVE_JERK //RAY testen
//#define REDUCE_ON_SMALL_SEGMENTS  //RAY testen
...
#define Z_PROBE_BED_DISTANCE 40.0 // Higher than max bed level distance error in mm
...
#define Z_PROBE_HEIGHT 1.80
/** These scripts are run before resp. after the z-probe is done. Add here code to activate/deactivate probe if needed. */
#define Z_PROBE_START_SCRIPT "M117 Z-Probing"
#define Z_PROBE_FINISHED_SCRIPT "M117 Z-Probe done"
...
#define AXISCOMP_TANXY 0.087 //0.5 degrees
...
#define CASE_LIGHTS_PIN ORIG_CASE_LIGHTS_PIN
...
//#undef FAN_BOARD_PIN
#define FAN_BOARD_PIN ORIG_FAN_BOARD_PIN
...
#define UI_PRINTER_NAME "GIOVANNI"
#define UI_PRINTER_COMPANY "RAyWB 5/1/17"
...
#define FEATURE_I2C_MACROS false//true
#define FEATURE_JOYSTICK_MOVE true  //!!!! activate only if joystick connected otherwise there is permanent moving

//end special stuff RAyWB
